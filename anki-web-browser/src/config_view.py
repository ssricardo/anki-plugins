...
class Ui_ConfigView(object):
    def setupUi(self, ConfigView):
        ...
        ConfigView.resize(500, 540)
        ConfigView.setFixedSize(500, 540)       # modif
        ...
        self.verticalLayWidget.setGeometry(ConfigView.geometry())   # changed
...
"}")
        ...
        self.teWordFilter.setMaximumSize(QtCore.QSize(300, 300))
        ...
        self.teShortcutMenu.setMaximumSize(QtCore.QSize(180, 300))
        ...
        self.teShortcutRepeat.setMaximumSize(QtCore.QSize(180, 300))
